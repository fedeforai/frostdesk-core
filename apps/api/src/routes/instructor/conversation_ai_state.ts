/**
 * Instructor-scoped conversation AI state toggle (takeover).
 * PATCH /instructor/conversations/:id/ai-state
 * Instructor must own the conversation. Writes audit_log with actor_type=instructor.
 */
