  ...
  recent_events: [
    {
      ...
      actor_type: 'admin',
      actor_id: 'abc12345-0000-0000-0000-000000000000',
      action: 'booking_confirmed',
      entity_type: 'booking',
      entity_id: 'bkng1234-0000-0000-0000-000000000000',
      severity: 'info',
    },
  ],
...
describe('buildDailyReport', () => {
  it('returns a valid xlsx buffer', async () => {
    const buf = await buildDailyReport(STUB, 'test');
  ...
  it('buffer size is reasonable (> 4 KB)', async () => {
    const buf = await buildDailyReport(STUB, 'test');
