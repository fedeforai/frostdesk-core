...
const REFUND_IT: LegalDocument = {
  ...
  sections: [
    ...
    { title: "2. Requisiti per il rimborso", body: <>Se non sei soddisfatto del servizio, puoi richiedere un rimborso entro <strong>14 giorni dall&apos;acquisto iniziale</strong>. I rimborsi possono essere concessi se: la richiesta è effettuata entro 14 giorni dal primo pagamento; l&apos;account non ha compiuto attività abusive o fraudolente; la richiesta è inviata alla nostra email di supporto. I rimborsi sono erogati a discrezione di FrostDesk. Per il deposito una tantum (es. €99) offerto sulla landing, si applica la stessa eligibilità di rimborso entro 14 giorni salvo diversa indicazione al checkout.</> },
...
const REFUND_FR: LegalDocument = {
  ...
  sections: [
    ...
    { title: "2. Éligibilité au remboursement", body: <>Si vous n'êtes pas satisfait du service, vous pouvez demander un remboursement sous <strong>14 jours après l'achat initial</strong>. Les remboursements peuvent être accordés si : la demande est faite dans les 14 jours ; le compte n'a pas eu d'activité abusive ou frauduleuse ; la demande est envoyée à notre email de support. Les remboursements sont accordés à la discrétion de FrostDesk. Pour le dépôt unique (ex. 99 €) proposé sur la landing, la même éligibilité de 14 jours s'applique sauf indication contraire au checkout.</> },
...
const REFUND_DE: LegalDocument = {
  ...
  sections: [
    ...
    { title: "2. Rückerstattungsberechtigung", body: <>Wenn du nicht zufrieden bist, kannst du innerhalb von <strong>14 Tagen nach dem ersten Kauf</strong> eine Rückerstattung beantragen. Voraussetzungen: Antrag innerhalb von 14 Tagen; kein Missbrauch oder Betrug; Antrag per Support-E-Mail. Rückerstattungen erfolgen nach Ermessen von FrostDesk. Für die einmalige Anzahlung (z. B. 99 €) auf der Landing gilt dieselbe 14-Tage-Regel, sofern nicht anders angegeben.</> },
