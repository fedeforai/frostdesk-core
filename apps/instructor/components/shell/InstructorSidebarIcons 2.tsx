/**
 * Professional SVG icons for instructor sidebar (no emoji).
 * 20×20, stroke-based, visible in collapsed (ritratto) rail and in full menu.
 */

const size = 20;
const stroke = 2;
const className = 'instructor-sidebar-icon';
...
export function IconFileEdit() {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={stroke} strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden>
      ...
      <path d="M14 2v6h6M11 15h2M11 11h4" />
    </svg>
  );
}
...
export function IconCalendarClock() {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={stroke} strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden>
      <rect x="3" y="4" width="18" height="18" rx="2" ry="2" />
      <path d="M16 2v4M8 2v4M3 10h18M12 14v4M10 18h4" />
...
export function IconGitBranch() {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={stroke} strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden>
      <path d="M6 3v12M18 9a3 3 0 100-6 3 3 0 000 6zM6 21a3 3 0 100-6 3 3 0 000 6zM15 6a9 9 0 01-9 9" />
    </svg>
  );
}
...
export function IconSparkles() {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={stroke} strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden>
      ...
      <path d="M5 19l1.25 2.5L9 22.5l-2.75-.75L5 19l-.75-2.75L1.5 19l2.75.75L5 19z" />
      <path d="M19 5l.75 2.25L22 8l-2.25.75L19 11l-.75-2.25L16 8l2.25-.75L19 5z" />
    </svg>
  );
}

export type InstructorSidebarIconName =
  | 'dashboard'
  | 'inbox'
  | 'fileEdit'
  | 'calendar'
...
const iconMap: Record<InstructorSidebarIconName, () => JSX.Element> = {
  dashboard: IconDashboard,
  inbox: IconInbox,
  fileEdit: IconFileEdit,
...
export function InstructorSidebarIcon({ name }: { name: InstructorSidebarIconName }) {
