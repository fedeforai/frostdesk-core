...
export default async function DashboardPage() {
  ...
  // Restore server-side dashboard data availability check: call API (uses adminComprehensiveDashboardRepository) with timeout guard.
  // On failure render fallback so the page does not crash.
