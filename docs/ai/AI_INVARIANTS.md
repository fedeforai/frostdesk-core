...
**Why:** Preventing the AI from making promises to customers is a business-critical safety requirement.
...
| PB-2 | Orchestrator imports booking_repository or outbound send | Scan import statements in `inbound_draft_orchestrator.ts` |
